...
import menuIcon from "@/app/assets/icons/icon-menu.png";
import Image from "next/image";
import styles from "./Header.module.scss";
import { CgClose } from "react-icons/cg";
import logo from "@/app/assets/Logo.png";
import cartIcon from "@/app/assets/icons/icon-cart.png";
import searchIcon from "@/app/assets/icons/icon-search.png";
import userIcon from "@/app/assets/icons/icon-user.png";
